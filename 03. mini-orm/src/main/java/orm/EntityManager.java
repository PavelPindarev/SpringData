...
public class EntityManager<E> implements DbContext<E> {
    ...
    @Override
    public Iterable<E> find(Class<E> table) throws InvocationTargetException, InstantiationException, IllegalAccessException, NoSuchMethodException, SQLException {
